...
public class JavaMail {
    ...
    public JavaMail(boolean debug) {
        InputStream in = JavaMail.class.getResourceAsStream("mail.properties");
        try {
            properties.load(in);
    ...
    public void doSendHtmlEmail(String subject, String sendHtml,
        ...
        try {
            ...
            InternetAddress from = 
            		new InternetAddress(MimeUtility.encodeWord("幻影") + " <" + sender_username + ">");
    ...
    public static void main(String[] args) {
        ...
        se.doSendHtmlEmail("邮件主题", "邮件内容", "66002172@qq.com");
    }
}
